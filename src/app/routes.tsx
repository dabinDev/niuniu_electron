...
import { canAccessAdminTools } from "./navigation";
...
export function RequireAdminTools({ children }: { children: ReactNode }) {
  ...
  if (!canAccessAdminTools(accessActivation)) {
...
export const routes: RouteObject[] = [
  ...
  { element: <RequireAdminTools><ShellPage><JobsPage /></ShellPage></RequireAdminTools>, path: "/jobs" }
];
